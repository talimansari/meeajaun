...
wp_enqueue_style( 'blankslate-style', get_stylesheet_uri() );
 ...
 wp_enqueue_style('allmin',get_stylesheet_directory_uri() .'/css/all.min.css');
 ...
 wp_enqueue_script('bottstrapjs',get_stylesheet_directory_uri() .'/js/bootstrap.min.js');
  wp_enqueue_script('aosjs',get_stylesheet_directory_uri() .'/js/aos.js');
...
register_sidebar( array(
'name' => esc_html__( 'footer1', 'blankslate' ),
'id' => 'footer1',
'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
'after_widget' => '</li>',
'before_title' => '<h3 class="widget-title">',
...
register_sidebar( array(
'name' => esc_html__( 'footer2', 'blankslate' ),
'id' => 'footer2',
'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
'after_widget' => '</li>',
'before_title' => '<h3 class="widget-title">',
...
register_sidebar( array(
'name' => esc_html__( 'footer3', 'blankslate' ),
'id' => 'footer3',
'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
'after_widget' => '</li>',
'before_title' => '<h3 class="widget-title">',
...
register_sidebar( array(
'name' => esc_html__( 'footer4', 'blankslate' ),
'id' => 'footer4',
'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
'after_widget' => '</li>',
'before_title' => '<h3 class="widget-title">',
